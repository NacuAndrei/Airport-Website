...
namespace Proiect
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProiectContext>(options => options            
            ...
            services.AddTransient<IPlanesManager, PlanesManager>();

            services.AddTransient<IRoutesRepository, RoutesRepository>();
            services.AddTransient<IRoutesManager, RoutesManager>();

            services.AddTransient<IUserInfosRepository, UserInfosRepository>();
            services.AddTransient<IUserInfosManager, UserInfosManager>();
